...
htpasswd -n developer
    ...
    developer:$apr1$KF5mctTo$n8HDsGUu/7tDDNypXDIOy0
...
echo 'developer:$apr1$KF5mctTo$n8HDsGUu/7tDDNypXDIOy0' | base64 -w0
  >> ZGV2ZWxvcGVyOiRhcHIxJEtGNW1jdFRvJG44SERzR1V1Lzd0REROeXBYRElPeTAK
